...
<head>
	...
	<script src="https://mpay.smartropay.co.kr/asset/js/SmartroPAY-1.0.min.js?version=${toDate}"></script>
	<script src="https://pay.smartropay.co.kr/asset/js/SmartroPAY-1.0.min.js?version=${toDate}"></script>
...
<body>
	<div class="wrapper reset" >
		...
		<form id="kcForm" name="kcForm" method="post" >
			 ...
			 <input type="hidden" name="VatAmt" value="0"/>
			 <input type="hidden" name="TaxAmt" value="0"/>
			 <input type="hidden" name="TaxFreeAmt" value="${goodsAmt}"/>
