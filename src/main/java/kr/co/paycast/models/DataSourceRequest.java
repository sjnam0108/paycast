...
public class DataSourceRequest {
    ...
    @SuppressWarnings("rawtypes")
	public DataSourceResult toEffectiveDataSourceResult(Session session, Class<?> clazz, 
			HashMap<String, Class<?>> classMap, boolean isEffectiveMode) {
    	try {
            Criteria criteria = session.createCriteria(clazz);
        	...
        	if (isEffectiveMode) {
        		...
        		criteria.add(Restrictions.and(rest1, Restrictions.or(rest2, rest3)));
        	}
	...
	public String toString() {
		return String
				.format("DataSourceRequest [page=%s, pageSize=%s, take=%s, skip=%s, sort=%s, group=%s, aggregate=%s, column=%s, data=%s, adminSiteId=%s, adminStbId=%s, adminCondId=%s, adminType=%s, reqStrValue1=%s, reqStrValue2=%s, reqStrValue3=%s, reqIntValue1=%s, reqIntValue2=%s, filter=%s]",
						page, pageSize, take, skip, sort, group, aggregate,
						column, data, adminSiteId, adminStbId, adminCondId,
						adminType, reqStrValue1, reqStrValue2, reqStrValue3,
						reqIntValue1, reqIntValue2, filter);
	}
