...
import kr.co.paycast.models.fnd.dao.LoginLogDao;
import kr.co.paycast.models.fnd.dao.UserDao;
...
public class UserServiceImpl implements UserService {
	...
	public void setUserViews(LoginUser loginUser, String currentSiteIdStr, String viewId, 
    	...
    	// [WAB] --------------------------------------------------------------------------
    	ArrayList<kr.co.paycast.viewmodels.MonitoringViewItem> viewList = new ArrayList<kr.co.paycast.viewmodels.MonitoringViewItem>();
    	...
    	if (currentSite != null && loginUser != null) {
	    	...
	    	if (anyChildSiteAccessAllowed && siteJobMngAllowed && childrenSiteList.size() > 0) {
	    		viewList.add(new kr.co.paycast.viewmodels.MonitoringViewItem(
	    				kr.co.paycast.viewmodels.MonitoringViewItem.ViewType.SiteAll, tmpIndent, 
	    	...
	    	if (siteJobMngAllowed) {
	    		viewList.add(new kr.co.paycast.viewmodels.MonitoringViewItem(
	    				kr.co.paycast.viewmodels.MonitoringViewItem.ViewType.Site, tmpIndent, 
    		...
    		if (anyChildSiteAccessAllowed && siteJobMngAllowed) {
        		for (Site childSite : childrenSiteList) {
    	    		viewList.add(new kr.co.paycast.viewmodels.MonitoringViewItem(
    	    				kr.co.paycast.viewmodels.MonitoringViewItem.ViewType.ChildSite, tmpIndent, 
    	...
    	if (loginUser != null) {
        	...
        	if (loginUser.getUserViews() != null) {
            	for(kr.co.paycast.viewmodels.MonitoringViewItem item : loginUser.getUserViews()) {
