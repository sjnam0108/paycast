 ...
 * 상점 관리 - 메뉴 컨트롤러
 */
@Controller("pay-store-menu-controller")
@RequestMapping(value="/pay/storemenu")
public class StoreMenuController {
    ...
    public String index(Model model, Locale locale, HttpSession session,
    	...
    	msgMgr.addViewMessages(model, locale,
    			new Message[] {
					new Message("pageTitle", "storemenu.title"),
...
//        				mandatoryMenus.add(new OptionalMenuItem(optMenu));
//        			} else if (optMenu.getOptType().equals("O")) {
//        				optionalMenus.add(new OptionalMenuItem(optMenu));
//        			}
    		...
    		/*
    		ArrayList<OptionalMenuItem> list = new ArrayList<OptionalMenuItem>();
    		
    		OptionalMenuItem a1 = new OptionalMenuItem();
    		a1.setId(1);
    		a1.setCount(3);
    		a1.setName("맛");
    		a1.setMenus("바닐라맛 +0,딸기맛 +0,초코맛 +0");
    		list.add(a1);
    		
    		OptionalMenuItem a2 = new OptionalMenuItem();
    		a2.setId(2);
    		a2.setCount(4);
    		a2.setName("매운정도");
    		a2.setMenus("아주 맵게 +0,조금 맵게 +0, 보통 +0, 안 맵게 +0");
    		list.add(a2);
    		
    		retMenu.setMandatoryMenus(list);
    		*/
