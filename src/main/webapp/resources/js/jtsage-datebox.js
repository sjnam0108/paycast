    ...
    $.widget("jtsage.datebox", {
        ...
        options: {
            ...
            s: {
                cal: {
                    ...
                    botButton: "<a href='#'style='size: 10px;' class='{cls}' role='button'><span class='{icon}'></span> {text}</a>"
                }
            },
        ...
        _controlGroup: function(element) {
            ...
            if (o.useCollapsedBut) {
            	var elementNum = element.find("a").length;
            	if(elementNum>1){
            		element.find("a").css({
                        width: (100/elementNum)+"%"
                    });		
            	}else{
	                element.find("a").css({
	                    width: "auto"
