    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body p-2">
				<div class='d-flex align-items-center justify-content-center py-4'>${wait_pleaseWait}</div>
            </div>
        </div>
    </div>
</div>
...
function openUploadModal(type, title) {
	...
	if (commonUploadType) {
	    ...
	    $("#commonUploadModal .modal-body").html("<div class='d-flex align-items-center justify-content-center py-4'>${wait_pleaseWait}</div>");
