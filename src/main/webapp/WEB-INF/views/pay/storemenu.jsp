...
<c:url value="/pay/storemenu/read" var="readUrl" />
<c:url value="/pay/storemenu/readMenu" var="readMenuUrl" />

<c:url value="/pay/storemenu/createGroups" var="createGroupUrl" />

<c:url value="/pay/storemenu/dropItem" var="dropItemUrl" />

<c:url value="/pay/storemenu/updateVisible" var="updateVisibleUrl" />
<c:url value="/pay/storemenu/updateGroup" var="updateGroupUrl" />
<c:url value="/pay/storemenu/destroyGroup" var="destroyGroupUrl" />

<c:url value="/pay/storemenu/createMenus" var="createMenuUrl" />
<c:url value="/pay/storemenu/destroyMenu" var="destroyMenuUrl" />
<c:url value="/pay/storemenu/updateMenu" var="updateMenuUrl" />

<c:url value="/pay/storemenu/upcmpl" var="uploadCmplUrl" />

<c:url value="/pay/storemenu/refresh" var="refreshUrl" />
...
.upload-root-div {	height: 200px; }

div.k-dropzone.k-dropzone-hovered em, div.k-dropzone em { color: #2e2e2e; }
.k-upload-files {	height: 100px;	overflow-x: hidden;	overflow-y: hidden; }
.k-upload .k-upload-files ~ .k-button {	width: 48%;	margin: 3px 3px 0.25em 1%; }
.k-upload .k-button {	height: 38px;	border-radius: .25rem; }
.k-upload .k-upload-button {	border-color: transparent;	background: #8897AA;	color: #fff; }
.k-upload .k-upload-button:hover {	background: #818fa2; }
.k-upload .k-upload-files ~ .k-upload-selected {	border-color: transparent;	background: #4c84ff;	color: #fff; }
.k-upload .k-upload-files ~ .k-upload-selected:hover {	background: #487df2; }
.k-upload .k-upload-files ~ .k-clear-selected {	background: transparent;	color: #4E5155;	border: 1px solid rgba(24,28,33,0.1); }
.k-upload .k-upload-files ~ .k-clear-selected:hover {	background: rgba(24,28,33,0.06); }
</style>
