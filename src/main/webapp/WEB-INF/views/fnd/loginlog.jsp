...
<%
	...
	String logoutDateTemplate = kr.co.paycast.utils.Util.getSmartDate("logoutDate");
%>
...
<kendo:grid name="grid" filterable="true" groupable="true" pageable="true" sortable="true" scrollable="false" reorderable="true" resizable="true" selectable="${value_gridSelectable}">
	...
	<kendo:grid-toolbarTemplate>
        ...
        <kendo:grid-columns>
            ...
            <kendo:grid-column title="${title_logout}" field="logout" width="100" template="#=logout ? \"<span class='fas fa-check'>\" : \"\"#" minScreenWidth="1300" />
            <kendo:grid-column title="${title_forcedLogout}" field="forcedLogout" width="100" template="#=forcedLogout ? \"<span class='fas fa-check'>\" : \"\"#" minScreenWidth="1400" />
        </kendo:grid-columns>
