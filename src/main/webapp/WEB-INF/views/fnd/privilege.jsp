...
<c:url value="/fnd/privilege/create" var="createUrl" />
<c:url value="/fnd/privilege/read" var="readUrl" />
<c:url value="/fnd/privilege/update" var="updateUrl" />
<c:url value="/fnd/privilege/destroy" var="destroyUrl" />
